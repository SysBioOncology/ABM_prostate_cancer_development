...
if cnst.newSystem
    ...
    for i=1:round(0.3*TUcellNo) %Choose placement of stem cells randomly
...
%     end
    ...
    %Luminal cell round
    L([TUcells,M1cells,M2cells,Fcells,Bcells, Ccells, CFcells]) = true;      %ensure that all cells are on the grid
